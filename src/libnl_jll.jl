...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libnl_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7c700954-19d3-5208-81e2-8fa5fe7c0bd8"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libnl", artifacts_toml) for e in artifacts["libnl"]]
...
if best_platform === nothing
    @debug("Unable to load libnl; unsupported platform $(triplet(platform_key_abi()))")
else
